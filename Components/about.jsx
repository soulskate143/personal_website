    ...
    <section className={styles.about} id="about">
      ...
      <div className={styles.experienceList}>
        ...
        <div className={styles.experienceItem}>
          ...
          <ul>
            <li>CEO of my own startup company.</li>
            <li>Assisted international clients (mostly Japanese companies).</li>
            ...
            <li>Prototyped smart cameras for Japanese companies.</li>
          </ul>
        </div>
        ...
        <div className={styles.experienceItem}>
          ...
          <ul>
            ...
            <li>Handled technical troubleshooting for office equipment.</li>
