...
const softwareProjects = [
  {
    ...
    description2: "A comprehensive digital solution that integrates advanced technologies to monitor, analyze, and optimize maritime activities in real time. Designed for ports, shipping companies, and logistics operators, the platform enhances safety, efficiency, and compliance across maritime ecosystems.",
...
>
  <Box 
    sx={{
      width: { xs: "95%", sm: "80%", md: "60%" }, // Adjusted for better responsiveness
      ...
      marginTop: "5%",
      position: "relative",
      boxShadow: "0px 15px 35px rgba(0, 0, 0, 0.3)", // Stronger shadow for depth
    }}
  >
    {/* Close Button */}
    <IconButton 
      ...
      sx={{ 
        ...
        color: "#333",
        transition: "0.3s",
        "&:hover": { color: "#ff5722" } // Subtle hover effect
      }}
    >
      <IoClose size={28} />
    </IconButton>
            ...
            <SwiperSlide key={index}>
              {image.endsWith(".mp4") ? (
                <video
                  ...
                  style={{
                    width: "100%",
                    height: "350px", // Reduced for better layout
                    maxHeight: "400px",
                ...
                <img
                  ...
                  style={{
                    ...
                    objectFit: "cover",
                    borderRadius: "8px",
                    boxShadow: "0px 5px 15px rgba(0, 0, 0, 0.2)", // Soft shadow for depth
                  }}
                />
              )}
            </SwiperSlide>
